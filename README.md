...
[![License](https://img.shields.io/github/license/cisagov/cyhy-account)](https://spdx.org/licenses/)
[![CodeQL](https://github.com/cisagov/cyhy-account/workflows/CodeQL/badge.svg)](https://github.com/cisagov/cyhy-account/actions/workflows/codeql-analysis.yml)
...
```hcl
module "example" {
  source = "github.com/cisagov/cyhy-account?ref=v1.1.0"
